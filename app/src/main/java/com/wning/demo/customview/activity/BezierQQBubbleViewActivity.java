...
import com.wning.demo.customview.view.BubbleView;

import java.util.ArrayList;
import java.util.List;

public class BezierQQBubbleViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bezier_bubble_view);
        initSystemView();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_main_bezier_qq_bubbleview, menu);
        return true;
    }
