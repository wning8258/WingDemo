 ...
 *************************************************************************************/
public class CornerPathEffectCustomView extends BaseCustomView {


    public CornerPathEffectCustomView(Context context) {
        super(context);
    }

    public CornerPathEffectCustomView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
