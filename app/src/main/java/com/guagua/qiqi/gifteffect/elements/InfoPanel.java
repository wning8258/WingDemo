...
public class InfoPanel extends AssembleBitmapElement implements BitmapOnDrawListener {
	...
	public final void addBitmapElement(BitmapShape bitmapShape,boolean isNeedSetListener) {
		addInnerElement(bitmapShape);
		if(isNeedSetListener){
...
//			canvas.drawPath(mClipPath, test_paint);
//			canvas.drawRect(mMeasurerect, test_paint);
//			canvas.drawRect(mInfoPanel, test_paint);
		}
		return true;
	}
